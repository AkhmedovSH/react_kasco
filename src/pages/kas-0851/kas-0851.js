            ...
            <div className="cont-area__grid">
              <div className="cont-area__header">
                <div className="cont-area__header-inner">
                  <div className="tab-area">
                    <a href="#!" className="tab-area__btn tab-area__btn--active"> {/* [D] 활성화 탭 버튼에 tab-area__btn--active 클래스 추가 */}
                      <span>출고요청</span>
                    </a>
              ...
              <div className="cont-area__section">
                ...
                <div className="btn-area gap-x40">
                  ...
                  <a href="#!" className="btn-base type-dark size-m grid-m">
                    <span>
                      자동배차
                    </span>
                  </a>
                          ...
                          <div className="table-wrap">
                            <table>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <th className="necessary">기본 운임비</th>
                                  <td>
                                    <div className="form-area">
                                      <div className="form-item">
                                        <input type="text" className="inp" />
